...
HD_PWD='C:/Users/perhat.amanlyyev/cs223-4/cs223-4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log disp2Dec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source disp2Dec.tcl -notrace

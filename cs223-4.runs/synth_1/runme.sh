...
HD_PWD='C:/Users/perhat.amanlyyev/cs223-4/cs223-4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log disp2Dec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source disp2Dec.tcl
